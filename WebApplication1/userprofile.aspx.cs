    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update member_master_tbl set full_name=@full_name, dob=@dob, contact_no=@contact_no, email=@email, campus=@campus, course=@course, school_mail=@school_mail, full_address=@full_address, password=@password, account_status=@account_status WHERE member_id='" + Session["username"].ToString().Trim() + "'", con);
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                DropDownList1.SelectedValue = dt.Rows[0]["campus"].ToString().Trim();
                TextBox6.Text = dt.Rows[0]["course"].ToString();
                TextBox7.Text = dt.Rows[0]["school_mail"].ToString();
