               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="Tesano" Value="Main campus" />
                              <asp:ListItem Text="AAbeka" Value="Abeka Campus" />
                              <asp:ListItem Text="Satellite campus" Value="Kumasi" />
                              <asp:ListItem Text="Takradi" Value="Takradi" />
                              <asp:ListItem Text="Ho" Value="Ho Campus" />
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox7" runat="server" placeholder="school mail" TextMode="Email"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
